...
# START BLOCK for debugging only, will be removed at compact release | NL_CODE: REMOVE_BLOCK
# TESTING
...
# END BLOCK for debugging only, will be removed at compact release | NL_CODE: / REMOVE_BLOCK
1;
__END__
